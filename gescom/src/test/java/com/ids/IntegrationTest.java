...
import com.ids.GescomApp;
import com.ids.ReactiveSqlTestContainerExtension;
import com.ids.config.TestSecurityConfiguration;
...
@SpringBootTest(classes = { GescomApp.class, TestSecurityConfiguration.class })
