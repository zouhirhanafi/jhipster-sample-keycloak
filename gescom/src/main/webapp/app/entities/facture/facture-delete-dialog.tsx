...
export const FactureDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gescomApp.facture.delete.question">
        <Translate contentKey="gescomApp.facture.delete.question" interpolate={{ id: factureEntity.id }}>
