  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gescomApp.commande.home.createOrEditLabel" data-cy="CommandeCreateUpdateHeading">
            <Translate contentKey="gescomApp.commande.home.createOrEditLabel">Create or edit a Commande</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('gescomApp.commande.date')} id="commande-date" name="date" data-cy="date" type="date" />
              <ValidatedField
                label={translate('gescomApp.commande.client')}
                id="commande-client"
                name="client"
                data-cy="client"
                type="text"
