...
import com.myapp.repository.CommandeRepository;
...
/**
 * REST controller for managing {@link com.myapp.domain.Commande}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CommandeResource {
    ...
    private static final String ENTITY_NAME = "myApp2Commande";
