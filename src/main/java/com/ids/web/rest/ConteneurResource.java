...
import com.ids.repository.ConteneurRepository;
import com.ids.service.ConteneurQueryService;
import com.ids.service.ConteneurService;
import com.ids.service.criteria.ConteneurCriteria;
...
/**
 * REST controller for managing {@link com.ids.domain.Conteneur}.
 */
@RestController
@RequestMapping("/api")
public class ConteneurResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSampleKeycloakConteneur";
