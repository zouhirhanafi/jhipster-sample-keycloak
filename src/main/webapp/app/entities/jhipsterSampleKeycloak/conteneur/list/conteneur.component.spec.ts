...
describe('Conteneur Management Component', () => {
  let comp: ConteneurComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ConteneurComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.conteneurs[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
